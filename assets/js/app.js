...
/**
 * Toggle serach in mobile devices
 */
    ...
    card.innerHTML = `
          ...
          <ul class="meta-list">
            <li class="meta-item">
              ...
              <p class="title-3 meta-text">${module.gatDate(
                dateUnix,
                timezone
              )}</p>
            </li>
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
                <div class="card card-sm slider-card">
                  ...
                  <img class="weather-icon" src="./assets/images/weather_icons/${icon}.png" width="48" height="48"
                    loading="lazy" alt="${description}" title="${description}">
        ...
        windLi.innerHTML = `
                <div class="card card-sm slider-card">
                  ...
                  <img class="weather-icon" src="./assets/images/weather_icons/direction.png" width="48" height="48"
                    loading="lazy" alt="direction" title="direction" style="transform: rotate(${
                      windDirection - 180
                    }deg)">
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          <div class="icon-wrapper">
            <img src="./assets/images/weather_icons/${icon}.png" width="36" height="36" alt="${description}" title="${description}"
              class="weather-icon">
            <span class="span">
